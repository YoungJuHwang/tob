...
<script type="text/javascript">
	$(function() {
		...
		Member.detail('${context}/member.Member.do?page=detail&userid=${member.userid}');
	});
	var Member = {
			detail : function(url) {
				$.getJSON(url,
			...
			updateForm : function() {
				$.getJSON('${context}/member/Member.do?page=detail&userid=${member.userid}',
						function(data){
						...
						$('#frm').submit(function(e) {
							...
							$.ajax('${context}/member/Member.do',{
								...
								success : function(data) {
									location.href="${context}/member/Member.do?page=mypage&userid="+data.userid;
								},
			...
			remove : function(userid) {
				$.ajax('${context}/member/Member.do',{
					...
					success : function(data) {
						alert('회원탈퇴 되었습니다.');
						location.href = "${context}/member/Member.do?page=logout";
					},
					error : function(xhr, status, msg) {
						alert('에러발생상태 : '+status +', 내용 :'+msg);
					}
